...
for method in "${methods[@]}"; do
    ...
    python3 train.py --out_dir=out --gate --n_kv_group=2 --eval_interval=50 --log_interval=1 --device=cpu --block_size=128 --batch_size=8 --n_layer=2 --n_head=4 --n_embd=16 --lr_decay_iters=2 --gate --dtype="float32" --max_iter=10000 --no-use_rotary_embeddings --use_abs_pos_embeddings --use_abs_pos_embeddings --no-use_post_ln
