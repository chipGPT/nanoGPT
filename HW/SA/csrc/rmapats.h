...
extern "C" {
#endif
void  hs_0_M_5_21__sim_daidir (UB  * pcode, scalar  val);
void  hs_0_M_5_0__sim_daidir (UB  * pcode, scalar  val);
void  hs_0_M_5_11__sim_daidir (UB  * pcode, scalar  val);
void  hs_0_M_6_21__sim_daidir (UB  * pcode, scalar  val);
void  hs_0_M_6_0__sim_daidir (UB  * pcode, scalar  val);
void  hs_0_M_6_1__sim_daidir (UB  * pcode, scalar  val, U  I699, scalar  * I1368, U  did);
void  hs_0_M_6_2__sim_daidir (UB  * pcode);
void  hs_0_M_6_11__sim_daidir (UB  * pcode, scalar  val);
void  hs_0_M_7_21__sim_daidir (UB  * pcode, scalar  val);
void  hs_0_M_7_0__sim_daidir (UB  * pcode, scalar  val);
void  hs_0_M_7_1__sim_daidir (UB  * pcode, scalar  val, U  I699, scalar  * I1368, U  did);
void  hs_0_M_7_2__sim_daidir (UB  * pcode);
void  hs_0_M_7_11__sim_daidir (UB  * pcode, scalar  val);
void  hs_0_M_8_21__sim_daidir (UB  * pcode, scalar  val);
void  hs_0_M_8_0__sim_daidir (UB  * pcode, scalar  val);
void  hs_0_M_8_1__sim_daidir (UB  * pcode, scalar  val, U  I699, scalar  * I1368, U  did);
void  hs_0_M_8_2__sim_daidir (UB  * pcode);
void  hs_0_M_8_11__sim_daidir (UB  * pcode, scalar  val);
